...
@section('title', $penciler->name)

@section('content')
    <main class="main">
        <h1 class="h1">Выпуски созданные художником {{$penciler->name}}</h1>

        @foreach($penciler->post as $post)
            <div class="post">
                ...
                <div class="post_description">
                    ...
                    <span class="post__text"><b>Художник: </b></span>  <a  class="aside__item" href="{{route('post_by_penciler', $penciler->key)}}">{{$penciler->name}}</a><br>
